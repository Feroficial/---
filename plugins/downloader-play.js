...
{ 
api: 'Stellar API', 
endpoint: `https://api.stellarwa.xyz/dl/ytmp3`, 
extractor: async (res) => {
// Asumiendo que la API necesita enviar la URL en el body como JSON
const response = await fetch(`https://api.stellarwa.xyz/dl/ytmp3`, {
method: 'POST',
headers: {
...
return response.downloadUrl || response.url || response.link
}
}
]
...
const link = await extractor(res)
